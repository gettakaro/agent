import type { IKnowledgeBaseFactory, KnowledgeBase, IngestionConfig } from '../types.js';
import type { ToolDefinition, ToolResult, ToolContext } from '../../agents/types.js';
 ...
 */
function createSearchTool(version: string): ToolDefinition {
  return {
    ...
    parameters: {
      ...
      properties: {
        query: {
          type: 'string',
          description:
            'The search query. Be specific about what you want to find.',
        },
        limit: {
          type: 'number',
...
export class TakaroDocsFactory implements IKnowledgeBaseFactory {
  ...
  createKnowledgeBase(version: string): KnowledgeBase {
    return {
      ...
      description:
        'Official Takaro documentation including guides, API references, and module development tutorials.',
